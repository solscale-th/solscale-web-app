...
export const MOCK_ENTREPRENEURS: Entrepreneur[] = [
  ...
  { id: "e5",  name: "WealthWise TH",            website: "wealthwise.th",         verified: true,  rating: 4.7, reviews: 41,  avatarBg: "bg-brand-tint", about: "WealthWise TH is Thailand's leading personal finance podcast, helping young professionals build wealth through practical, actionable advice." },
